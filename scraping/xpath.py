...
RELATIVE_XPATH_GENERAL_COMMENT_REPLY_AGREEMENTS = (
    "article/article/div[2]/div[2]/div/ul/li[1]/button[2]/span/span[2]"
)
RELATIVE_XPATH_GENERAL_COMMENT_REPLY_ACKNOWLEDGEMENTS = (
    "article/article/div[2]/div[2]/div/ul/li[2]/button[2]/span/span[2]"
)
RELATIVE_XPATH_GENERAL_COMMENT_REPLY_DISAGREEMENTS = (
