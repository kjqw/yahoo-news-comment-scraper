...
RELATIVE_XPATH_ARTICLE_LERAN_COUNT = [
...
RELATIVE_XPATH_ARTICLE_CLARITY_COUNT = [
    ...
    "article/div[5]/ul/li[2]/div/span",
]
RELATIVE_XPATH_ARTICLE_NEW_PERSPECTIVE_COUNT = [
    "article/div[3]/ul/li[3]/div/span",
    "article/div[4]/ul/li[3]/div/span",
    "article/div[5]/ul/li[3]/div/span",
]
